...
class UpProjectionBlock(nn.Module):
    def __init__(self, num_filter, kernel_size=6, stride=2, padding=2, bias=True, activation='lrelu'):
        ...
        self.up_conv2 = torch.nn.Conv2d(num_filter, num_filter, kernel_size, stride, padding, groups=1, bias=bias)
        self.r2 = torch.nn.LeakyReLU(0.2, True)
...
class DownProjectionBlock(nn.Module):
    def __init__(self, num_filter, kernel_size=6, stride=2, padding=2, bias=True, activation='lrelu'):
        ...
        self.down_conv1 = torch.nn.Conv2d(num_filter, num_filter, kernel_size, stride, padding, groups=1, bias=bias)
        self.r1 = torch.nn.LeakyReLU(0.2, True)
        self.down_conv2 = PSBlock(num_filter)
        self.down_conv3 = torch.nn.Conv2d(num_filter, num_filter, kernel_size, stride, padding, groups=1, bias=bias)
        self.r3 = torch.nn.LeakyReLU(0.2, True)
